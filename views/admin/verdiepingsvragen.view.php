				...
				<section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
					<div class="flex flex-wrap items-start justify-between gap-4">
						<div>
							...
							<p class="mt-1 text-sm text-slate-600">Veldkoppeling: <strong>Leefgebied</strong>, <strong>Functie</strong>, <strong>Aandachtspunt</strong>, <strong>Vraag</strong>.</p>
						</div>
					...
					<div class="mt-4 flex flex-wrap items-center gap-3">
						<div class="relative min-w-[220px] flex-1">
							<input id="verdiepingSearchInput" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 pr-9 text-sm shadow-sm focus:border-[#A53714] focus:outline-none focus:ring-2 focus:ring-[#A53714]/20" placeholder="Zoek op leefgebied, functie, vraag of aandachtspunt..." />
					...
					<div class="mt-4 overflow-x-auto rounded-xl border border-slate-200">
						<table class="min-w-full divide-y divide-slate-200" id="verdiepingTable" data-source-table="gids_verdieping_vragen">
							...
							<tbody id="verdiepingTableBody" class="divide-y divide-slate-200 bg-white">
								...
								<?php else: ?>
									<tr>
										<td colspan="5" class="px-4 py-6 text-center text-sm text-slate-500">Nog geen verdiepingsvragen gevonden.</td>
									</tr>
								<?php endif; ?>
							</tbody>
						</table>
